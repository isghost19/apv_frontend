  ...
  return (
    <>
        ...
        >
            ...
            <div className="mb-5">
                <label htmlFor="simtomas" className="text-gray-700 uppercase font-bold">Sintomas</label>
                <textarea 
                    id="simtomas"
            ...
            <input 
                ...
                className="bg-indigo-600 text-white uppercase font-bold w-full p-3 hover:bg-indigo-800 cursor-pointer transition-colors rounded-md"
            />
        </form>
    </>
  )
